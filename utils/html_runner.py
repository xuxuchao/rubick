...
<style type="text/css" media="screen">
    ...
    .failClass  { background-color: #ffc9c9; }
    .errorClass { background-color: #ffefa4; }
    .passCase   { color: #239F41; }
    .failCase   { color: #C00000; font-weight: bold; }
    .errorCase  { color: #FDDA22; font-weight: bold; }
...
class HTMLTestRunner(Template_mixin):
    ...
    def __init__(self, stream=sys.stdout, verbosity=0, title=None, description=None):
        self.stream = stream
        self.verbosity = verbosity
        if title is None:
